...
![Eduardo Junqueira's GitHub Stats](URL_DA_IMAGEM_DE_ESTATS_DO_GITHUB)

## Tecnologias que eu uso no meu dia
![C](URL_DA_IMAGEM)
![Java](URL_DA_IMAGEM)
![MySQL](URL_DA_IMAGEM)
![Python](URL_DA_IMAGEM)
![Arduino IDE](URL_DA_IMAGEM)
![IntelliJ IDEA](URL_DA_IMAGEM)
![Visual Studio Code](URL_DA_IMAGEM)
